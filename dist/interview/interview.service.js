...
let InterviewService = class InterviewService {
    ...
    startInterview(user) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.interviewRepository.save(newInterview);
            return newInterview;
        });
    }
    updateInterview(id, QandAs) {
        return __awaiter(this, void 0, void 0, function* () {
            const interview = yield this.findInterview(id);
            const newContent = [...interview.content, ...QandAs];
            yield this.interviewRepository.update({ id: interview.id }, { content: newContent });
            const updatedInterview = yield this.findInterview(id);
            return updatedInterview;
        });
    }
    findInterview(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const interview = yield this.interviewRepository.findOne({
                where: { id },
            });
            if (!interview) {
...
exports.InterviewService = InterviewService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(interview_entity_1.InterviewEntity)),
