...
let ProfileService = class ProfileService {
    constructor(userRepository, purchaseRepository) {
        this.userRepository = userRepository;
        this.purchaseRepository = purchaseRepository;
    }
    changeNickname(user, nickname) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.userRepository.update({ user_id: user.user_id }, { nickname });
        });
    }
    getUserPlan(user) {
        return __awaiter(this, void 0, void 0, function* () {
...
exports.ProfileService = ProfileService = __decorate([
    ...
    __param(1, (0, typeorm_1.InjectRepository)(purchase_entity_1.PurchaseEntity)),
