...
let RestoreController = class RestoreController {
    constructor(restoreService, purchaseService) {
        this.restoreService = restoreService;
        this.purchaseService = purchaseService;
    }
    restoreAccount(purchaseToken) {
        return __awaiter(this, void 0, void 0, function* () {
            const account = yield this.purchaseService.findUserByPurchaseToken(purchaseToken);
            return account.user;
        });
    }
};
...
__decorate([
    (0, common_1.Get)(),
    __param(0, (0, common_1.Headers)('purchaseToken')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], RestoreController.prototype, "restoreAccount", null);
